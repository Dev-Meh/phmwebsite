...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "MediCore — Pharmacy Management System" },
      { name: "description", content: "Secure, role-based pharmacy management for drugs, sales, and inventory." },
      { property: "og:title", content: "MediCore — Pharmacy Management System" },
      { property: "og:description", content: "Secure, role-based pharmacy management for drugs, sales, and inventory." },
